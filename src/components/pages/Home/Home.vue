      ...
      <div class="menu-wrap">
        <div class="menu-content">
          ...
          <div class="rules">
            ...
            <p> Сервіс призначено для створення скарг до Державної автомобільної інспекції України на
            ...
            <p>Заявка може оброблятися протягом 30 робочих днiв.</p>
          </div>
        </div>
      </div>
    </div>
